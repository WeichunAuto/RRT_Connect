...
if algo.newPoint is not None:
    plt.scatter(algo.newPoint[0], algo.newPoint[1], s=38, c='blue')
if algo.previousNewTPoint is not None:
...
# plt.scatter(algo.junctionNodes[0][0], algo.junctionNodes[0][1], s=18, c='green')
# plt.scatter(algo.junctionNodes[1][0], algo.junctionNodes[1][1], s=18, c='green')
